...
import com.bsl.parser.bslParser;
import com.bsl.psi.bslFile;
...
public class bslParserDefinition implements ParserDefinition{
    ...
    public static final IFileElementType FILE = new IFileElementType(Language.<bsl>findInstance(bsl.class));

    @NotNull
    @Override
    public Lexer createLexer(Project project) {
        return new FlexAdapter(new bslLexer((Reader) null));
    }
